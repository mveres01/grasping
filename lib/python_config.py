...
config_fov = 50.0*(3.14159265/180).
config_collected_data_dir = '/scratch/mveres/collected'
config_processed_data_dir = os.path.join(project_dir, 'data/processed')
config_sample_image_dir = os.path.join(processed_data_dir, 'sample_images')
config_sample_pose_dir = os.path.join(processed_data_dir, 'sample_poses')

# Used for split_dataset.py, postprocess.py
# What we'll call the output dataset
